...
<body>
	...
	<c:if test="${ !empty member }">
		...
		<form action="${ pageContext.request.contextPath }/tUpdate.tn"
						...
						<td colspan="3">
							<div id="titleImgArea">
								...
								<img id="titleImg" width="350" height="200" 
										...
										/resources/thumbnailUploadFiles
						...
						<td>
							<div id="contentImgArea1">
								...
								<img id="contentImg1" width="120" height="100"
									src="${ pageContext.request.contextPath }
										/resources/thumbnailUploadFiles
										/${ fileList.get(1).getChangename() }">
								</c:if>		
								<c:if test="${ fileList.size() < 2 }">
                				<p id="contentImg1" width="120" height="100">이미지가 등록되지 않았습니다.</p>
            				    </c:if>
							</div>
						</td>
						<td>
							<div id="contentImgArea2">
								...
								<img id="contentImg2" width="120" height="100"
									src="${ pageContext.request.contextPath }
										/resources/thumbnailUploadFiles
										/${ fileList.get(2).getChangename() }">
								</c:if>
								<c:if test="${ fileList.size() < 3 }">
                				<p id="contentImg2" width="120" height="100">이미지가 등록되지 않았습니다.</p>
            				    </c:if>
							</div>
						</td>
						<td>
							<div id="contentImgArea3">
								...
								<img id="contentImg3" width="120" height="100"
									src="${ pageContext.request.contextPath }
										/resources/thumbnailUploadFiles
										/${ fileList.get(3).getChangename() }">
								</c:if>
								<c:if test="${ fileList.size() < 4 }">
                				<p id="contentImg3" width="120" height="100">이미지가 등록되지 않았습니다.</p>
            				    </c:if>
							</div>
						</td>
